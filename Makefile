...
install: build
	gnome-extensions install --force eruption-sensor@x3n0m0rph59.org.shell-extension.zip

	@echo "Success! Please restart the GNOME shell for the changes to take effect."

uninstall:
	gnome-extensions uninstall eruption-sensor@x3n0m0rph59.org
...
clean:
	rm eruption-sensor@x3n0m0rph59.org.shell-extension.zip
